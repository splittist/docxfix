...
3. M3.3: BDD row mapping helper + tests. ✅ **Complete** — `bdd_mapping.py`, 51 tests.
4. M3.4: Docs/examples cleanup. ✅ **Complete** — smoke tests for all 8 example specs + batch manifest, `bdd_row_example.py`, updated phase-3-guide with `bdd_mapping` usage.
